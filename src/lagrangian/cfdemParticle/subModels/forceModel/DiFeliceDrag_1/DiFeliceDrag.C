...
//                     voidfraction, Ufluid, U_.mesh().V()[cellI], ds );  
		...
		//////////////////////////////////////////  NUMAP  ////////////////////////////////////////////////
		///////////////////////////////////////////////////////////////////////////////////////////////////
       	 	labelList adjacent = particleCloud_.mesh().cellCells()[cellI];
		Pout << "Partilce_Index = " << index << endl;
		Pout << "cellI_main = " << cellI << endl;
		Pout << "adjacent = " << adjacent << endl;
		Pout << "Position = " << position << endl;
		Pout << "U_f_main = " << U_[cellI] << endl;
        	for (int in = 0 ; in<adjacent.size() ; in++)
		{
			Pout << "cellI_Neighbour = " << adjacent[in]<< endl;
			vector position_neig       = particleCloud_.position(in, particleBased_);
			Pout << "Position Neighbour (cellI=" << adjacent[in] << ") = " << position_neig << endl;
			Pout << "U_f (cellI=" << adjacent[in] << ") = " << U_[adjacent[in]] << endl;
		}
		
