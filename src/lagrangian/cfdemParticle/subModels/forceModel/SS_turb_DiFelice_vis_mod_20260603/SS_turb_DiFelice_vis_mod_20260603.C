...
#include "SS_turb_DiFelice_vis_mod_20260603.H"
...
defineTypeNameAndDebug(SS_turb_DiFelice_vis_mod_20260603, 0);

addToRunTimeSelectionTable
(
    forceModel,
    SS_turb_DiFelice_vis_mod_20260603,
    dictionary
);
...
SS_turb_DiFelice_vis_mod_20260603::SS_turb_DiFelice_vis_mod_20260603
(
...
void SS_turb_DiFelice_vis_mod_20260603::setForce() const
{
            ...
            if (cellI > -1) // particle Found
            {
                ...
                */
                ...
                if (magUr > 0)
                {
                    ...
                    if (mag(drag_vis)>0)
                    {
                        drag_vis_lift = drag+force_vis - Vs*gradP*rho;
                    }
                    double n = 1;
                    if (U_star[0] != 0)
                    {
